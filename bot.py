...
qa1 = ('@MikFilippov, @Konstantin_Gladun, @Azamat_Gu, @Igor_Kirichek')
tl1 = ('@ashutay, @DmitryMatlah')
tlqa = ('@gryzb1')
back1 = ('@ivleonov, @tshloman, @mmeiko, @barysh_vn, @DmitryChernoyarov')
front1 = ('@Frozenzxc, @Spartfin, @chimir, @Danil_Abr')
